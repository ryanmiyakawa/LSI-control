classdef _ReticleCoarseStage < JavaDevice
    ...
    methods
        ...
        function this = ReticleCoarseStage(clock)
    ...
    methods (Access = private)
        ...
        function init(this)
            ...
            this.cJarPath           = fullfile(pwd, 'ReticleCoarseProxy.jar');
            this.cPackage           = 'cxro.common.device.motion';
            this.cConstructFcn      = 'ReticleCoarseStage(''M141-Stage'',''iman.lbl.gov'')';
            ...
            this.hioX = HardwareIO('Reticle-Coarse-X', this.clock, 'X');
            this.hioY = HardwareIO('Reticle-Coarse-Y', this.clock, 'Y');
            this.hioZ = HardwareIO('Reticle-Coarse-Z', this.clock, 'Z');
            this.hioRx = HardwareIO('Reticle-Coarse-Rx', this.clock, 'Rx');
            this.hioRy = HardwareIO('Reticle-Coarse-Ry', this.clock, 'Ry');
