classdef Scan < HandlePlus
    ...
    properties
        ...
        ceData          % data
        cePreviousSscans% a celle containing previous scans
        ...
        function start(this)
            ...
            try
                if this.isRangeValid()
                    ...
                    this.msg(...
                        sprintf('%s:going to its first position\n',this.cName), 3) %TODO remove when finalized
