...
% See also AXISSETUP, AXISVIRTUAL, AXISAPIGENERIC, HARDWAREIO
    ...
    methods(Hidden)
        ...
        %HANDLELOWLIMITCHANGE Callback to deal with RAW/Cal mode
            ...
            if this.uitCal.lVal
                this.uieDest.dMin = this.asSetup.uieLowLimitCal.val();
            else
                this.uieDest.dMin = this.asSetup.uieLowLimitRaw.val();
            end  
        end
        ...
        %HANDLEHIGHLIMITCHANGE Callback to deal with RAW/Cal mode
            ...
            if this.uitCal.lVal
                this.uieDest.dMax = this.asSetup.uieHighLimitCal.val();
            else
                this.uieDest.dMax = this.asSetup.uieHighLimitRaw.val();
            end   
        end
