    ...
    methods
        ...
        function build(this)
            ...
            this.hPanel = uipanel(...
                ...
                'FontWeight', 'Bold',...
                'Clipping', 'on',...
                'Position', Utils.lt2lb([this.dLeft this.dTop this.dWidth this.dHeight], this.hParent));
			drawnow;
            ...
            this.hButton = uicontrol(...
                'Parent', this.hPanel,...
                'Position', Utils.lt2lb([dXOffset dTop this.dButtonWidth this.dButtonHeight], this.hPanel),...
            ...
            dTop = dTop + this.dButtonHeight + this.dUIPad;
           	...
           	this.hList = uicontrol( ...
                'Parent', this.hPanel, ...
                'Position', Utils.lt2lb([dXOffset dTop this.dButtonWidth 100], this.hPanel),...
                'Style', 'listbox', ...
           ...
           dTop = dTop + this.dButtonHeight + this.dUIPad;
            ...
            this.hButtonGroup = uibuttongroup( ...
                ...
                'Position', Utils.lt2lb([dXOffset dTop this.dButtonWidth 4*this.dButtonHeight], this.hPanel),...
            ...
            u0 = uicontrol(...
                'Style', 'radiobutton', ...
                'String', 'Option 1', ...
                'pos', Utils.lt2lb([10 20 100 30], this.hButtonGroup), ...
            ...
            u1 = uicontrol( ...
                'Style', 'radiobutton', ...
                'String', 'Option 2', ...
                'pos', Utils.lt2lb([10 50 100 30], this.hButtonGroup), ...
                'parent', this.hButtonGroup,  ...
                'HandleVisibility','off' ...
                );
            u2 = uicontrol( ...
                'Style', 'radiobutton', ...
                'String', 'Option 3', ...
                'pos', Utils.lt2lb([10 80 100 30], this.hButtonGroup), ...
                'parent', this.hButtonGroup,  ...
                'HandleVisibility', 'off' ...
                );
...
%             this.ppHairColor.ceOptions = ceVal;
%         end 
%         
...
%             this.lbHairStyle.ceOptions = ceVal;
%         end 
%         
