classdef UIList < HandlePlus
    ...
    properties (Access = private)
        ...
        lShowDelete     % show delete button
        lShowMove       % show move buttons
        lShowLabel      % show label
        lShowRefresh    % show refresh button.  If you show this, you need
                        % to supply the function handle to use that returns
                        % a cell of options
...
%                 )
            ...
            this.cLabel         = cLabel;
            this.lShowDelete    = lShowDelete;
            this.lShowMove      = lShowMove;
            this.lShowLabel     = lShowLabel;
            this.lShowRefresh   = lShowRefresh;
       ...
       function removeSelected(this)
           ...
           notify(this, 'eDelete', EventWithData(stData));
