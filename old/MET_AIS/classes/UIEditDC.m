classdef UIEditDC < HandlePlus
%% UIEditDC Class for MET5 Software
...
% Antoine Wojdyla, April 3rd, 2013    
    ...
    methods
        ...
        %% constructor
        function this= UIEditDC(cLabel, cType, lShowLabel, hCallback)
                ...
                try
                    ...
                    if (isequal(size(dInputData),[1 1]) ... 
                       ...
                       cMsg = sprintf('The val you are trying to set (%s) not between the limits: low = %1.2e, high = %1.2e.  Restoring last good value.', ...
                        ...
                        cTitle = 'UIEditDC.set.cData() error';
                        msgbox(cMsg, cTitle, 'warn') 
        ...
        %             fprintf('UIEditDC.set.cData(%s) this.cLabel = %s\n', ...
        %                 this.cData, ...
        %                 this.cLabel);
        ...
        function setMinMaxVal(this, mixedMin, mixedMax, mixedVal)
            ...
            % units of a UIEditDC instance (i.e., the one in the axis
        ...
        function setVal(this, mixed)
           % @parameter (mixed) mixed: can be any type the UIEditDC supports
           ...
           elseif (strcmp(this.cType, 'c') && ischar(mixed))
               ...
               msgbox(msg, 'UIEditDC.setVal() invalid type', 'error');
           end
