classdef _PupilFill < HandlePlus
%PUPILFILL Class that allows to monitor and the control of the Pupil fill
%
%   See also PUPILFILLCORE, RETICLEPICK, HEIGHTSENSOR
    ...
    methods
        ...
        function this = PupilFill(cl, cDevice)
        ...
        % See also INIT, BUILD, DELETE
            ...
            this.cSaveDir = sprintf('scanner-%s', this.cDevice);
...
%             end
        ...
        function handleSavedDelete(this, src, evt)
            ...
            for k = 1:length(evt.stData.ceOptions)
                ...
                cFile = sprintf('%s../pupilfill/%s.mat', ...
                    this.cDir, ...
