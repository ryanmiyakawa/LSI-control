...
% all of the listeners have logic to execute or not
    ...
    properties (Access = private)
        ...
        %   ceTaskFcn:cell of type function_hanele          (1xm)
...
%% Methods
        ...
        % lReturn = clock.has('task name')
            ...
            % strcmp(char, cell) returns a logical array
            % use & (not &&) to do a logical and on thre turn from strcmp()
            % and this.lTaskActive.  This returns a type logical array
        ...
        %   Clock.timerFcn(src, evt)
            ...
            if this.lEcho
                 cMsg = sprintf( ...
                    'Clock.timerFcn() @ %1.2f with %1.0f tasks.  Executing %1.0f', ...
                    dElapsedTime, ...
