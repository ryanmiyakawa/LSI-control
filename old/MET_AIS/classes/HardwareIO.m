...
%                     end
    ...
    methods (Access = protected)
        ...
        %HANDLELOWLIMITCHANGE Callback to deal with RAW/Cal mode
            ...
            if this.uitCal.lVal
                this.uieDest.dMin = this.setup.uieLowLimitCal.val();
            else
                this.uieDest.dMin = this.setup.uieLowLimitRaw.val();
            end  
        end
        ...
        %HANDLEHIGHLIMITCHANGE Callback to deal with RAW/Cal mode
            ...
            if this.uitCal.lVal
                this.uieDest.dMax = this.setup.uieHighLimitCal.val();
            else
                this.uieDest.dMax = this.setup.uieHighLimitRaw.val();
            end   
        end
