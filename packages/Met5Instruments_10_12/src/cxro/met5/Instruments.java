...
import cxro.common.device.Camera.PixisCamera;
...
import cxro.met5.device.lsi.LsiCamera;
...
public class Instruments
{
  ...
  throws IOException
  {
    ...
    section = ini.get("LsiCamera");
    lsiCamera = new LsiCamera(section.get("nodename"), section.get("locator"));
  ...
  public final PixisCamera getLsiCamera()
  {
    return lsiCamera.getLsiCamera();
  }
