...
%             this.build();
        ...
        function initUi(this)
           ...
           for k = 1:length(this.cReticleLabels)
               ...
               stConfigs(1).fhGet = @() this.hardware.getDeltaTauPowerPmac().getXReticleCoarse();
               stConfigs(1).fhSet = @(dVal) this.hardware.getDeltaTauPowerPmac().setXReticleCoarse(dVal);
               stConfigs(1).fhIsReady = @() ~this.hardware.getDeltaTauPowerPmac().getIsStartedReticleCoarseXYZTipTilt();
               
               stConfigs(2).fhGet = @() this.hardware.getDeltaTauPowerPmac().getYReticleCoarse();
               stConfigs(2).fhSet = @(dVal) this.hardware.getDeltaTauPowerPmac().setYReticleCoarse(dVal);
               stConfigs(2).fhIsReady = @() ~this.hardware.getDeltaTauPowerPmac().getIsStartedReticleCoarseXYZTipTilt();
               
               stConfigs(3).fhGet = @() this.hardware.getDeltaTauPowerPmac().getZReticleCoarse();
               stConfigs(3).fhSet = @(dVal) this.hardware.getDeltaTauPowerPmac().setZReticleCoarse(dVal);
               stConfigs(3).fhIsReady = @() ~this.hardware.getDeltaTauPowerPmac().getIsStartedReticleCoarseXYZTipTilt();
               
               stConfigs(4).fhGet = @() this.hardware.getDeltaTauPowerPmac().getTiltXReticleCoarse();
               stConfigs(4).fhSet = @(dVal) this.hardware.getDeltaTauPowerPmac().setTiltXReticleCoarse(dVal);
               stConfigs(4).fhIsReady = @() ~this.hardware.getDeltaTauPowerPmac().getIsStartedReticleCoarseXYZTipTilt();
               ...
               stConfigs(6).fhIsReady = @() ~this.hardware.getDeltaTauPowerPmac().getIsStartedReticleFineXY();
               
               stConfigs(7).fhGet = @() this.hardware.getDeltaTauPowerPmac().getYReticleFine();
               stConfigs(7).fhSet = @(dVal) this.hardware.getDeltaTauPowerPmac().setYReticleFine(dVal);
               stConfigs(7).fhIsReady = @() ~this.hardware.getDeltaTauPowerPmac().getIsStartedReticleFineXY();
           ...
           for k = 1:length(this.cWaferLabels)
               ...
               stConfigs(3).fhGet = @() this.hardware.getDeltaTauPowerPmac().getZWaferCoarse();
               stConfigs(3).fhSet = @(dVal) this.hardware.getDeltaTauPowerPmac().setZWaferCoarse(dVal);
